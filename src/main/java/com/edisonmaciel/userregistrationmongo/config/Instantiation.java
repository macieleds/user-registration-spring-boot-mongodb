...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post("1", sdf.parse("21/03/2018"), "Partiu Viagem!", "Vou vajar para São Paulo. Abraços.", maria);
		Post post2 = new Post("1", sdf.parse("23/03/2018"), "Bom dia!", "Acordei feliz hoje.", maria);
